...
export default function PostThread() {
  ...
  const postThread = async () => {
    if (spool) {
      setLockInputs(true);
      try {
        const success = await ThreadAPI.postThread(
          title,
          threadType === ThreadTypes.TEXT ? contentText : contentUrl,
          "topic-placeholder",
          spool.id,
          threadType
        );
              ...
              <CardBody>
                ...
                <Stack spacing="3">
                  ...
                  <FormControl>
                    ...
                    <RadioGroup
                      onChange={(t) => {
                        setThreadType(t as ThreadTypes);
                      }}
                      value={threadType}
                    >
                      <HStack spacing={"8"}>
                    ...
                    {threadType === ThreadTypes.TEXT ? (
                      <>
                        <Tabs>
                          <TabList>
                            <Tab>Edit</Tab>
                            <Tab isDisabled={contentText.length === 0}>
                              Preview
                            </Tab>
                          </TabList>
                          <TabPanels>
